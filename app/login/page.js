...
const Login = () => {
    ...
    // If session exists, we show a redirecting message
    if (session) {
        return (
    ...
    // If no session, show the login options
    return (
        <>
            ...
            <div className="flex flex-col gap-2 min-h-screen p-10 items-center">
                ...
                <button onClick={() => signIn("google")}
                    className="w-80 flex items-center bg-white border border-gray-300 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium text-gray-800 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-slate-500">
